...
public class ScheduleController {
    ...
    @PostMapping
    public ResponseEntity<CreateScheduleResponse> createCalendar(@RequestBody CreateScheduleRequest request) {
    ...
    @GetMapping()
    public ResponseEntity<List<GetScheduleResponse>> getAllCalendars(@RequestParam(required = false) String author) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<UpdateScheduleResponse> updateCalendarById(
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCalendarById(
            @PathVariable Long id,
